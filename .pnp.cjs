...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "dependencyTreeRoots": [\
      {\
        "name": "monorepo_buildkite",\
        "reference": "workspace:."\
      },\
      {\
        "name": "product-service",\
        "reference": "workspace:packages/product-service"\
      },\
      {\
        "name": "user-service",\
        "reference": "workspace:packages/user-service"\
      }\
    ],\
    "enableTopLevelFallback": true,\
    "ignorePatternData": "(^(?:\\\\.yarn\\\\/sdks(?:\\\\/(?!\\\\.{1,2}(?:\\\\/|$))(?:(?:(?!(?:^|\\\\/)\\\\.{1,2}(?:\\\\/|$)).)*?)|$))$)",\
    "fallbackExclusionList": [\
      ["monorepo_buildkite", ["workspace:."]],\
      ["product-service", ["workspace:packages/product-service"]],\
      ["user-service", ["workspace:packages/user-service"]]\
    ],\
    "fallbackPool": [\
    ],\
    "packageRegistryData": [\
      ...
      ["product-service", [\
        ["workspace:packages/product-service", {\
          "packageLocation": "./packages/product-service/",\
          "packageDependencies": [\
            ["product-service", "workspace:packages/product-service"],\
            ["cors", "npm:2.8.5"],\
            ["debug", "virtual:b86a9fb34323a98c6519528ed55faa0d9b44ca8879307c0b29aa384bde47ff59a7d0c9051b31246f14521dfb71ba3c5d6d0b35c29fffc17bf875aa6ad977d9e8#npm:4.3.4"],\
      ...
      ["user-service", [\
        ["workspace:packages/user-service", {\
          "packageLocation": "./packages/user-service/",\
          "packageDependencies": [\
            ["user-service", "workspace:packages/user-service"],\
            ["cors", "npm:2.8.5"],\
            ["debug", "virtual:b86a9fb34323a98c6519528ed55faa0d9b44ca8879307c0b29aa384bde47ff59a7d0c9051b31246f14521dfb71ba3c5d6d0b35c29fffc17bf875aa6ad977d9e8#npm:4.3.4"],\
